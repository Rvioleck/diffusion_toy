...
def main(args):
    ...
    if args.train:
        ...
        # 训练模型
        ddpm = train_model(loader, args.epochs, args.learning_rate, args.checkpoint_dir, args.dataset, device)
        ...
        generate_and_show_inference_images(model_path, args.log_dir, args.dataset, device)
    else:

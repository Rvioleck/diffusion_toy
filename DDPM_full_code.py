...
# In[1]:
#!cd "E:\MyNotes\AI_learning\My Notes\MM4R\algorithm_learning\DDPM\diffusion_from02hero\DDPM\utils.py"
...
store_path = STORE_PATH_FASHION if fashion else STORE_PATH_MNIST
